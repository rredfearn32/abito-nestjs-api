...
export declare class GoalsController {
    ...
    getAllGoalsForUser(req: any): Promise<GoalsResponseDto[]>;
    getGoalById(goalId: string, req: any): Promise<GoalsResponseDto | undefined>;
    ...
    updateGoal(_: string, updatedGoal: UpdateGoalDto, req: any): Promise<GoalsResponseDto>;
